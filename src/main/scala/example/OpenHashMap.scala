...
/**
  ...
  */
class OpenHashMap[@specialized(Long, Int, Double) K : ClassTag, @specialized(Long, Int, Double) V: ClassTag](initialCapacity: Int) extends Iterable[(K, V)] with Serializable {
